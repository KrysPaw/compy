...
- **Magic-link mail:** subject/body are localized `en`/`pl` from the requester’s UI locale (passed on `POST /auth/magic-link`). Copy lives in an API-local catalog ([`apps/api/src/auth/magic-link-mail.ts`](../../apps/api/src/auth/magic-link-mail.ts)), not next-intl. Missing locale defaults to `en`.
...
- **Switcher:** language submenu inside the account dropdown in `SidebarFooter` of [`app-sidebar.tsx`](../../apps/web/components/sidebar/app-sidebar.tsx) ([`sidebar-user-menu.tsx`](../../apps/web/components/sidebar/sidebar-user-menu.tsx)). Labels in the language’s own name (`English` / `Polski`). Same control in the collapsed and mobile sidebar.
- **`html lang`:** follows the active locale.
- **Fonts:** add `latin-ext` to Noto Sans in [`apps/web/app/layout.tsx`](../../apps/web/app/layout.tsx) so Polish diacritics render. Headings use the same face via `--font-heading` → `--font-sans`.
...
- Mount via account menu in `SidebarFooter` ([`sidebar-user-menu.tsx`](../../apps/web/components/sidebar/sidebar-user-menu.tsx))
...
- [`app-sidebar.tsx`](../../apps/web/components/sidebar/app-sidebar.tsx), [`comparison-tabs.tsx`](../../apps/web/components/comparison/comparison-tabs.tsx)
- Create/delete dialogs and action menus (comparison, criterion, entry)
- [`rules-data-table.tsx`](../../apps/web/components/rules/rules-data-table.tsx), [`enum-rule-dialog.tsx`](../../apps/web/components/rules/enum-rule-dialog.tsx), [`weight-questionnaire-dialog.tsx`](../../apps/web/components/rules/weight-questionnaire-dialog.tsx)
- [`results-data-table.tsx`](../../apps/web/components/results/results-data-table.tsx), [`comparison-data-table.tsx`](../../apps/web/components/entries/comparison-data-table.tsx), [`criteria-data-table.tsx`](../../apps/web/components/criteria/criteria-data-table.tsx)
- [`entry-value-field.tsx`](../../apps/web/components/entries/entry-value-field.tsx), page blurbs under `app/(app)/comparisons/[id]/`
