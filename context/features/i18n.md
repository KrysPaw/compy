...
- **Switcher:** language submenu inside the account dropdown in `SidebarFooter` of [`app-sidebar.tsx`](../../apps/web/components/app-sidebar.tsx) ([`sidebar-user-menu.tsx`](../../apps/web/components/sidebar-user-menu.tsx)). Labels in the language’s own name (`English` / `Polski`). Same control in the collapsed and mobile sidebar.
...
- Mount via account menu in `SidebarFooter` ([`sidebar-user-menu.tsx`](../../apps/web/components/sidebar-user-menu.tsx))
